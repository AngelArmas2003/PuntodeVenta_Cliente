        ...
        <ContentTemplate>
            <div class="jumbotron">
                ...
                <asp:GridView ID="GVEstamots" runat="server" AllowPaging="True"
                    ...
                    OnSelectedIndexChanged="GVEstamots_SelectedIndexChanged" PageSize="15"
                ...
                <div align="center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="display: flex; justify-content: left; padding: 10px;">
                            <asp:TextBox ID="txtEstamto" runat="server" Width="296px" Style="text-transform: uppercase" class="form-control CajaTexto"></asp:TextBox>
                        </div>
                    </div>
